...
templates['preferences.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  buffer += "          <option value=\"add-path\">Add new python path</option>\n        </select>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"defaultVariables\">\n          Default Variables\n          <a data-toggle=\"tooltip\" data-placement=\"right\" title=\"<p class='small'>Configure default variables that will be created when Rodeo is started. This is just a Python script that is executed on startup.</p>\" data-html=\"true\"><i class=\"fa fa-question-circle\"></i></a>\n        </label>\n        <button class=\"btn btn-xs btn-primary\" onclick=\"showRodeoProfile();\">Configure</button>\n      </div>\n      <div class=\"form-group\">\n        <div style=\"width:20%; max-width: 25%;\">\n          <label for=\"fontType\">Font Type</label>\n          <select onchange=\"setFontType($(this).val());\" class=\"form-control\" id=\"fontType\" name=\"fontType\" type=\"number\" value=\""
    ...
    + ">Inconsolata</option>\n              <option value=\"Menlo\" "
    + ((stack1 = (helpers.compare || (depth0 && depth0.compare) || alias2).call(alias1,(depth0 != null ? depth0.fontType : depth0),(depth0 != null ? depth0.Menlo : depth0),{"name":"compare","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ">Menlo</option>\n              <option value=\"Monaco\" "
    + ((stack1 = (helpers.compare || (depth0 && depth0.compare) || alias2).call(alias1,(depth0 != null ? depth0.fontType : depth0),(depth0 != null ? depth0.Monaco : depth0),{"name":"compare","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ">Monaco</option>\n              <option value=\"Open Sans\" "
    + ((stack1 = (helpers.compare || (depth0 && depth0.compare) || alias2).call(alias1,(depth0 != null ? depth0.fontType : depth0),"Open Sans",{"name":"compare","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
