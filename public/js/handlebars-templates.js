...
templates['preferences.hbs'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "> Display Dot Files\n            <a data-toggle=\"tooltip\" data-placement=\"right\" title=\"<p class='small'>When checked, 'dotfiles' and directories (i.e. `.git`) will be displayed. NOTE: When updated, this will take affect upon restart.</p>\" data-html=\"true\"><i class=\"fa fa-question-circle\"></i></a>\n          </label>\n        </div>\n        <div class=\"checkbox\">\n          <label>\n            <input onchange=\"setTracking($(this).prop('checked'));\" type=\"checkbox\" ";
