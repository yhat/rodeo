...
/***/ function(module, exports, __webpack_require__) {
	...
	var _startup = __webpack_require__(422);
	
	var _startup2 = _interopRequireDefault(_startup);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	_reactDom2.default.render(_react2.default.createElement(_startup2.default, null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _electron = __webpack_require__(361);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _setupReady = __webpack_require__(423);
	
	var _setupReady2 = _interopRequireDefault(_setupReady);
	
	var _loadingWidget = __webpack_require__(424);
	
	var _loadingWidget2 = _interopRequireDefault(_loadingWidget);
	
	var _setupPython = __webpack_require__(425);
	
	var _setupPython2 = _interopRequireDefault(_setupPython);
	
	var _tour = __webpack_require__(426);
	
	var _tour2 = _interopRequireDefault(_tour);
	
	var _tourData = __webpack_require__(428);
	...
	var _ipc = __webpack_require__(360);
	...
	exports.default = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    if (!state.pythonOptions) {
	      if (!state.systemFacts) {
	        (0, _ipc.send)('get_system_facts').then(function (facts) {
	  ...
	  close: function close() {
	    return (0, _ipc.send)('close_window', 'startupWindow');
	  },
	  handleInstallPython: function handleInstallPython() {
	    return (0, _ipc.send)('install_python');
	  },
	  ...
	  render: function render() {
	    ...
	    if (!state.pythonOptions) {
	      if (!state.systemFacts) {
	        ...
	        content = _react2.default.createElement(_loadingWidget2.default, null);
	      } else {
	        // no python in systemFacts, so ask them for it
	        content = _react2.default.createElement(_setupPython2.default, {
	      ...
	      content = _react2.default.createElement(_tour2.default, { onExitTour: this.handleExitTour,
	        tourData: _tourData2.default
	      });
	    }
	
	    if (!content) {
	      content = _react2.default.createElement(_setupReady2.default, { onReady: this.handleReady });
	    }
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('br', null),
	      _react2.default.createElement('br', null),
	      _react2.default.createElement('img', { src: 'img/loading.gif', style: style }),
	      _react2.default.createElement('br', null),
	      _react2.default.createElement('br', null),
	      _react2.default.createElement('br', null),
	      _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  propTypes: {
	    onInstallPython: _react2.default.PropTypes.func.isRequired,
	    onSelect: _react2.default.PropTypes.func.isRequired,
	    onSelectPythonDialog: _react2.default.PropTypes.func.isRequired,
	    platform: _react2.default.PropTypes.oneOf(['win32', 'linux', 'darwin'])
	  },
	  getInitialState: function getInitialState() {
	    return { pythonPath: '' };
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tourItem = __webpack_require__(427);
	...
	exports.default = _react2.default.createClass({
	  displayName: 'Tour',
	  propTypes: {
	    onExitTour: _react2.default.PropTypes.func.isRequired,
	    tourData: _react2.default.PropTypes.array.isRequired
	  },
	  componentDidMount: function componentDidMount() {
	    (0, _jquery2.default)(_reactDom2.default.findDOMNode(this).querySelector('#tour')).owlCarousel({ singleItem: true });
	  },
	  render: function render() {
	    var tourItems = this.props.tourData.map(function (item, i) {
	      return _react2.default.createElement(_tourItem2.default, _extends({}, item, { key: i }));
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  propTypes: {
	    ...
	    img2: _react2.default.PropTypes.string.isRequired,
	  ...
	  render: function render() {
	    ...
	    img = _react2.default.createElement('img', { src: this.props.img,
	      style: style
	    });
	    if (this.props.img2) {
	      img = _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'col-sm-6' },
	          _react2.default.createElement('img', { src: this.props.img2,
	            style: style
	          })
	        )
	      );
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('br', null),
	      _react2.default.createElement('br', null),
	      _react2.default.createElement('p', { className: 'lead', dangerouslySetInnerHTML: { __html: this.props.subtitle } })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(352)(content, {"sourceMap":true});
